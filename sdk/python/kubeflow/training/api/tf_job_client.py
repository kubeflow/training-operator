...
from kubeflow.training.api.tf_job_watch import watch as tfjob_watch
...
class TFJobClient(object):
    ...
    def create(self, tfjob, namespace=utils.get_default_target_namespace()):
        """
        Create the TFJob
        ...
        logging.info("TFJob {} has been created".format(tfjob.metadata.name))
    ...
    def create_tfjob_from_func(
        ...
        # Create TFJob.
        self.create(tfjob=tfjob, namespace=namespace)
    ...
    def delete(self, name, namespace=utils.get_default_target_namespace()):
        ...
        logging.info("TFJob {} has been deleted".format(name))
