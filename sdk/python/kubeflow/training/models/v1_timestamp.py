...
class V1Timestamp(object):
    ...
    def __init__(self, nanos=0, seconds=0, local_vars_configuration=None):  # noqa: E501
        """V1Timestamp - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def nanos(self):
        """Gets the nanos of this V1Timestamp.  # noqa: E501
        ...
        :return: The nanos of this V1Timestamp.  # noqa: E501
        :rtype: int
        """
        return self._nanos
    ...
    def nanos(self, nanos):
        """Sets the nanos of this V1Timestamp.

        Non-negative fractions of a second at nanosecond resolution. Negative second values with fractions must still have non-negative nanos values that count forward in time. Must be from 0 to 999,999,999 inclusive. This field may be limited in precision depending on context.  # noqa: E501

        :param nanos: The nanos of this V1Timestamp.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and nanos is None:  # noqa: E501
    ...
    @property
    def seconds(self):
        """Gets the seconds of this V1Timestamp.  # noqa: E501
        ...
        :return: The seconds of this V1Timestamp.  # noqa: E501
        :rtype: int
        """
    ...
    def seconds(self, seconds):
        """Sets the seconds of this V1Timestamp.

        Represents seconds of UTC time since Unix epoch 1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to 9999-12-31T23:59:59Z inclusive.  # noqa: E501

        :param seconds: The seconds of this V1Timestamp.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1Timestamp):
            return False
