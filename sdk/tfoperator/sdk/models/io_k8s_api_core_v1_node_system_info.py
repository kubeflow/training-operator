...
class IoK8sApiCoreV1NodeSystemInfo(object):
  ...
  def architecture(self, architecture):
    ...
    if architecture is None:
      raise ValueError(
        "Invalid value for `architecture`, must not be `None`")  # noqa: E501
  ...
  def boot_id(self, boot_id):
    ...
    if boot_id is None:
      raise ValueError(
        "Invalid value for `boot_id`, must not be `None`")  # noqa: E501
  ...
  def kernel_version(self, kernel_version):
    ...
    if kernel_version is None:
      raise ValueError(
        "Invalid value for `kernel_version`, must not be `None`")  # noqa: E501
  ...
  def kubelet_version(self, kubelet_version):
    ...
    if kubelet_version is None:
      raise ValueError(
        "Invalid value for `kubelet_version`, must not be `None`")  # noqa: E501
  ...
  def machine_id(self, machine_id):
    ...
    if machine_id is None:
      raise ValueError(
        "Invalid value for `machine_id`, must not be `None`")  # noqa: E501
  ...
  def os_image(self, os_image):
    ...
    if os_image is None:
      raise ValueError(
        "Invalid value for `os_image`, must not be `None`")  # noqa: E501
  ...
  def system_uuid(self, system_uuid):
    ...
    if system_uuid is None:
      raise ValueError(
        "Invalid value for `system_uuid`, must not be `None`")  # noqa: E501
