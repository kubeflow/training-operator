...
class IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR(object):
  ...
  def client_cidr(self, client_cidr):
    ...
    if client_cidr is None:
      raise ValueError(
        "Invalid value for `client_cidr`, must not be `None`")  # noqa: E501
  ...
  def server_address(self, server_address):
    ...
    if server_address is None:
      raise ValueError(
        "Invalid value for `server_address`, must not be `None`")  # noqa: E501
  ...
  def to_dict(self):
    ...
    for attr, _ in six.iteritems(self.swagger_types):
      ...
      if isinstance(value, list):
        ...
        result[attr] = value
    if issubclass(IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR,
                  dict):
