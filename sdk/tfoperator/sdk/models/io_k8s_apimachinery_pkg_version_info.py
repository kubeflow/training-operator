...
class IoK8sApimachineryPkgVersionInfo(object):
  ...
  def build_date(self, build_date):
    ...
    if build_date is None:
      raise ValueError(
        "Invalid value for `build_date`, must not be `None`")  # noqa: E501
  ...
  def compiler(self, compiler):
    ...
    if compiler is None:
      raise ValueError(
        "Invalid value for `compiler`, must not be `None`")  # noqa: E501
  ...
  def git_commit(self, git_commit):
    ...
    if git_commit is None:
      raise ValueError(
        "Invalid value for `git_commit`, must not be `None`")  # noqa: E501
  ...
  def git_tree_state(self, git_tree_state):
    ...
    if git_tree_state is None:
      raise ValueError(
        "Invalid value for `git_tree_state`, must not be `None`")  # noqa: E501
  ...
  def git_version(self, git_version):
    ...
    if git_version is None:
      raise ValueError(
        "Invalid value for `git_version`, must not be `None`")  # noqa: E501
  ...
  def go_version(self, go_version):
    ...
    if go_version is None:
      raise ValueError(
        "Invalid value for `go_version`, must not be `None`")  # noqa: E501
  ...
  def major(self, major):
    ...
    if major is None:
      raise ValueError(
        "Invalid value for `major`, must not be `None`")  # noqa: E501
  ...
  def minor(self, minor):
    ...
    if minor is None:
      raise ValueError(
        "Invalid value for `minor`, must not be `None`")  # noqa: E501
  ...
  def platform(self, platform):
    ...
    if platform is None:
      raise ValueError(
        "Invalid value for `platform`, must not be `None`")  # noqa: E501
