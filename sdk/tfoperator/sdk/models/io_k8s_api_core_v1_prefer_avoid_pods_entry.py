...
import six
from tfoperator.sdk.models.io_k8s_api_core_v1_pod_signature import IoK8sApiCoreV1PodSignature  # noqa: F401,E501
...
class IoK8sApiCoreV1PreferAvoidPodsEntry(object):
  ...
  def pod_signature(self, pod_signature):
    ...
    if pod_signature is None:
      raise ValueError(
        "Invalid value for `pod_signature`, must not be `None`")  # noqa: E501
