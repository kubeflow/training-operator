...
class IoK8sApimachineryPkgApisMetaV1ExportOptions(object):
  ...
  def __init__(self, api_version=None, exact=None, export=None,
               kind=None):  # noqa: E501
  ...
  def exact(self, exact):
    ...
    if exact is None:
      raise ValueError(
        "Invalid value for `exact`, must not be `None`")  # noqa: E501
  ...
  def export(self, export):
    ...
    if export is None:
      raise ValueError(
        "Invalid value for `export`, must not be `None`")  # noqa: E501
