...
import six
from tfoperator.sdk.models.io_k8s_api_core_v1_volume_projection import IoK8sApiCoreV1VolumeProjection  # noqa: F401,E501
...
class IoK8sApiCoreV1ProjectedVolumeSource(object):
  ...
  def sources(self, sources):
    ...
    if sources is None:
      raise ValueError(
        "Invalid value for `sources`, must not be `None`")  # noqa: E501
