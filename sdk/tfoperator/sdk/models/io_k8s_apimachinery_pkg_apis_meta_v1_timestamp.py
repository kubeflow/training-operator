...
class IoK8sApimachineryPkgApisMetaV1Timestamp(object):
  ...
  """
    ...
    """
  swagger_types = {'nanos': 'int', 'seconds': 'int'}

  attribute_map = {'nanos': 'nanos', 'seconds': 'seconds'}
  ...
  def nanos(self, nanos):
    ...
    if nanos is None:
      raise ValueError(
        "Invalid value for `nanos`, must not be `None`")  # noqa: E501
  ...
  def seconds(self, seconds):
    ...
    if seconds is None:
      raise ValueError(
        "Invalid value for `seconds`, must not be `None`")  # noqa: E501
