...
class IoK8sApimachineryPkgRuntimeUnknown(object):
  ...
  def content_encoding(self, content_encoding):
    ...
    if content_encoding is None:
      raise ValueError(
        "Invalid value for `content_encoding`, must not be `None`"
      )  # noqa: E501
  ...
  def content_type(self, content_type):
    ...
    if content_type is None:
      raise ValueError(
        "Invalid value for `content_type`, must not be `None`")  # noqa: E501
  ...
  def raw(self, raw):
    ...
    if raw is None:
      raise ValueError(
        "Invalid value for `raw`, must not be `None`")  # noqa: E501
