...
class IoK8sApiCoreV1Taint(object):
  ...
  def __init__(self, effect=None, key=None, time_added=None,
  ...
  def effect(self, effect):
    ...
    if effect is None:
      raise ValueError(
        "Invalid value for `effect`, must not be `None`")  # noqa: E501
  ...
  def key(self, key):
    ...
    if key is None:
      raise ValueError(
        "Invalid value for `key`, must not be `None`")  # noqa: E501
