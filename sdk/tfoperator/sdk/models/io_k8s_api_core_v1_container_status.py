...
import six
from tfoperator.sdk.models.io_k8s_api_core_v1_container_state import IoK8sApiCoreV1ContainerState  # noqa: F401,E501
...
class IoK8sApiCoreV1ContainerStatus(object):
  ...
  def image(self, image):
    ...
    if image is None:
      raise ValueError(
        "Invalid value for `image`, must not be `None`")  # noqa: E501
  ...
  def image_id(self, image_id):
    ...
    if image_id is None:
      raise ValueError(
        "Invalid value for `image_id`, must not be `None`")  # noqa: E501
  ...
  def ready(self, ready):
    ...
    if ready is None:
      raise ValueError(
        "Invalid value for `ready`, must not be `None`")  # noqa: E501
  ...
  def restart_count(self, restart_count):
    ...
    if restart_count is None:
      raise ValueError(
        "Invalid value for `restart_count`, must not be `None`")  # noqa: E501
