...
class IoK8sApimachineryPkgApisMetaV1APIResource(object):
  ...
  def namespaced(self, namespaced):
    ...
    if namespaced is None:
      raise ValueError(
        "Invalid value for `namespaced`, must not be `None`")  # noqa: E501
  ...
  def singular_name(self, singular_name):
    ...
    if singular_name is None:
      raise ValueError(
        "Invalid value for `singular_name`, must not be `None`")  # noqa: E501
  ...
  def verbs(self, verbs):
    ...
    if verbs is None:
      raise ValueError(
        "Invalid value for `verbs`, must not be `None`")  # noqa: E501
