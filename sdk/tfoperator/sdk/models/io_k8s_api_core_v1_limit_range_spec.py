...
import six
from tfoperator.sdk.models.io_k8s_api_core_v1_limit_range_item import IoK8sApiCoreV1LimitRangeItem  # noqa: F401,E501
...
class IoK8sApiCoreV1LimitRangeSpec(object):
  ...
  """
    ...
    """
  swagger_types = {'limits': 'list[IoK8sApiCoreV1LimitRangeItem]'}
  ...
  def limits(self, limits):
    ...
    if limits is None:
      raise ValueError(
        "Invalid value for `limits`, must not be `None`")  # noqa: E501
