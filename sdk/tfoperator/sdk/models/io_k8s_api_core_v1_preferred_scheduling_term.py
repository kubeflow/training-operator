...
import six
from tfoperator.sdk.models.io_k8s_api_core_v1_node_selector_term import IoK8sApiCoreV1NodeSelectorTerm  # noqa: F401,E501
...
class IoK8sApiCoreV1PreferredSchedulingTerm(object):
  ...
  def preference(self, preference):
    ...
    if preference is None:
      raise ValueError(
        "Invalid value for `preference`, must not be `None`")  # noqa: E501
  ...
  def weight(self, weight):
    ...
    if weight is None:
      raise ValueError(
        "Invalid value for `weight`, must not be `None`")  # noqa: E501
