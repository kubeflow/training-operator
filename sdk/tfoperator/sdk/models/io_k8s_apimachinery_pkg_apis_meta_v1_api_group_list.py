...
import six
from tfoperator.sdk.models.io_k8s_apimachinery_pkg_apis_meta_v1_api_group import IoK8sApimachineryPkgApisMetaV1APIGroup  # noqa: F401,E501
...
class IoK8sApimachineryPkgApisMetaV1APIGroupList(object):
  ...
  def groups(self, groups):
    ...
    if groups is None:
      raise ValueError(
        "Invalid value for `groups`, must not be `None`")  # noqa: E501
