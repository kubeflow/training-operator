...
import six
from tfoperator.sdk.models.io_k8s_apimachinery_pkg_runtime_object import IoK8sApimachineryPkgRuntimeObject  # noqa: F401,E501
...
class IoK8sApimachineryPkgApisMetaV1InternalEvent(object):
  ...
  """
    ...
    """
  swagger_types = {'object': 'IoK8sApimachineryPkgRuntimeObject', 'type': 'str'}
  ...
  def object(self, object):
    ...
    if object is None:
      raise ValueError(
        "Invalid value for `object`, must not be `None`")  # noqa: E501
  ...
  def type(self, type):
    ...
    if type is None:
      raise ValueError(
        "Invalid value for `type`, must not be `None`")  # noqa: E501
