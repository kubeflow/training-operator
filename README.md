...
Building a docker container with your code is the most commmon way
to deploy your code.

Alternatively, if you don't want to build docker images each time
you change your code, here are some options to consider:

  * Mounting a shared filesystem as a volume in you TfJob containers
    and making code available through that filesystem

  * Using an init container or script inside your container to pull
    your code e.g. from GCS or HDFS
