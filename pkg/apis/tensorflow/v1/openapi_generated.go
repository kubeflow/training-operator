...
func schema_pkg_apis_tensorflow_v1_TFJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"onExit": {
						SchemaProps: spec.SchemaProps{
							Description: "at the end of the tensorflow training, OnExit always executes irrespective of success or failure",
		...
		Dependencies: []string{
			"github.com/kubeflow/common/job_controller/api/v1.ReplicaSpec", "k8s.io/api/core/v1.PodTemplateSpec"},
	}
}
