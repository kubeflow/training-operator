...
func (in *TFJobSpec) DeepCopyInto(out *TFJobSpec) {
	*out = *in
	if in.CleanPodPolicy != nil {
		...
		*out = new(commonv1beta1.CleanPodPolicy)
		**out = **in
	}
	...
	if in.TFReplicaSpecs != nil {
		...
		*out = make(map[TFReplicaType]*commonv1beta1.ReplicaSpec, len(*in))
		for key, val := range *in {
			var outVal *commonv1beta1.ReplicaSpec
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(commonv1beta1.ReplicaSpec)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
