...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kubeflow/tf-operator/pkg/apis/common/v1.JobCondition":  schema_pkg_apis_common_v1_JobCondition(ref),
		"github.com/kubeflow/tf-operator/pkg/apis/common/v1.JobStatus":     schema_pkg_apis_common_v1_JobStatus(ref),
		"github.com/kubeflow/tf-operator/pkg/apis/common/v1.ReplicaSpec":   schema_pkg_apis_common_v1_ReplicaSpec(ref),
		"github.com/kubeflow/tf-operator/pkg/apis/common/v1.ReplicaStatus": schema_pkg_apis_common_v1_ReplicaStatus(ref),
...
func schema_pkg_apis_common_v1_JobStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"conditions": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kubeflow/tf-operator/pkg/apis/common/v1.JobCondition"),
									},
								},
							},
						},
					...
					"replicaStatuses": {
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kubeflow/tf-operator/pkg/apis/common/v1.ReplicaStatus"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/tf-operator/pkg/apis/common/v1.JobCondition", "github.com/kubeflow/tf-operator/pkg/apis/common/v1.ReplicaStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
