	...
	return &XGBoostJob{
		Spec: XGBoostJobSpec{
			...
			XGBReplicaSpecs: map[commonv1.ReplicaType]*commonv1.ReplicaSpec{
				XGBoostReplicaTypeWorker: &commonv1.ReplicaSpec{
...
func TestSetDefaults_XGBoostJob(t *testing.T) {
	testCases := map[string]struct {
		...
		"set spec with minimum setting": {
			...
			expected: expectedXGBoostJob(commonv1.CleanPodPolicyAll, DefaultRestartPolicy, 1, DefaultPortName, DefaultPort),
		},
		"Set spec with restart policy": {
			...
			expected: expectedXGBoostJob(commonv1.CleanPodPolicyAll, commonv1.RestartPolicyOnFailure, 1, DefaultPortName, DefaultPort),
		},
		"Set spec with replicas": {
			...
			expected: expectedXGBoostJob(commonv1.CleanPodPolicyAll, DefaultRestartPolicy, 3, DefaultPortName, DefaultPort),
		},
		...
		"Set spec with node port": {
			...
			expected: expectedXGBoostJob(commonv1.CleanPodPolicyAll, DefaultRestartPolicy, 1, DefaultPortName, 9999),
		},
	}
