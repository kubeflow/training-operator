...
def test_load_config(test_name, test_config, expected, huggingface_model_instance):
...
def test_download_model(test_name, test_case, huggingface_model_instance):
