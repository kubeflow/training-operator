...
import (
	...
	tfjobinformersv1beta2 "github.com/kubeflow/tf-operator/pkg/client/informers/externalversions/tensorflow/v1beta2"
...
type TFController struct {
	...
	updateStatusHandler func(tfjob *tfv1beta2.TFJob) error

	// To allow injection of deleteTFJob for testing.
	deleteTFJobHandler func(tfjob *tfv1beta2.TFJob) error
...
func (tc *TFController) reconcileTFJobs(tfjob *tfv1beta2.TFJob) error {
	...
	if isSucceeded(tfjob.Status) || isFailed(tfjob.Status) || tfJobExceedsLimit {
		...
		if tfJobExceedsLimit {
			logger.Infof(">>>>>> TFJobs was ExceedsLimit  %s", tfjob.Name)
...
func (tc *TFController) GetJobFromAPIClient(namespace, name string) (metav1.Object, error) {
	return tc.tfJobClientSet.KubeflowV1beta2().TFJobs(namespace).Get(name, metav1.GetOptions{})
}

func (tc *TFController) GetAPIGroupVersionKind() schema.GroupVersionKind {
	return tfv1beta2.SchemeGroupVersionKind
}

func (tc *TFController) GetAPIGroupVersion() schema.GroupVersion {
	return tfv1beta2.SchemeGroupVersion
}
