...
var (
	controllerKind = tfv1beta1.SchemeGroupVersionKind
)

func NewBasePod(name string, tfJob *tfv1beta1.TFJob, t *testing.T) *v1.Pod {
	return &v1.Pod{
...
func NewPod(tfJob *tfv1beta1.TFJob, typ string, index int, t *testing.T) *v1.Pod {
...
func NewPodList(count int32, status v1.PodPhase, tfJob *tfv1beta1.TFJob, typ string, start int32, t *testing.T) []*v1.Pod {
	pods := []*v1.Pod{}
...
func SetPodsStatuses(podIndexer cache.Indexer, tfJob *tfv1beta1.TFJob, typ string, pendingPods, activePods, succeededPods, failedPods int32, t *testing.T) {
	var index int32
