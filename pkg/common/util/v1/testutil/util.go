...
var (
	...
	GroupName      = trainingv1.GroupVersion.Group
...
func ConvertTFJobToUnstructured(tfJob *trainingv1.TFJob) (*unstructured.Unstructured, error) {
...
func GetKey(tfJob *trainingv1.TFJob, t *testing.T) string {
...
func CheckCondition(tfJob *trainingv1.TFJob, condition commonv1.JobConditionType, reason string) bool {
