...
var (
	controllerKind = tfv1beta2.SchemeGroupVersionKind
)

func NewBasePod(name string, tfJob *tfv1beta2.TFJob, t *testing.T) *v1.Pod {
	return &v1.Pod{
...
func NewPod(tfJob *tfv1beta2.TFJob, typ string, index int, t *testing.T) *v1.Pod {
...
func NewPodList(count int32, status v1.PodPhase, tfJob *tfv1beta2.TFJob, typ string, start int32, t *testing.T) []*v1.Pod {
	pods := []*v1.Pod{}
