...
func GenOwnerReference(tfjob *tfv1beta2.TFJob) *metav1.OwnerReference {
	boolPtr := func(b bool) *bool { return &b }
	controllerRef := &metav1.OwnerReference{
		APIVersion:         tfv1beta2.SchemeGroupVersion.String(),
		Kind:               tfv1beta2.Kind,
		Name:               tfjob.Name,
		UID:                tfjob.UID,
...
func ConvertTFJobToUnstructured(tfJob *tfv1beta2.TFJob) (*unstructured.Unstructured, error) {
...
func GetKey(tfJob *tfv1beta2.TFJob, t *testing.T) string {
...
func CheckCondition(tfJob *tfv1beta2.TFJob, condition common.JobConditionType, reason string) bool {
