...
func NewTFJobWithNamespace(worker, ps int, ns string) *tfv1beta1.TFJob {
	tfJob := NewTFJob(worker, ps)
	tfJob.Namespace = ns
...
func NewTFJobNamespaceAndRpcLayer(worker, ps int, ns string, rpclayer string) *tfv1beta1.TFJob {
	tfJob := NewTFJob(worker, ps)
	tfJob.Namespace = ns
...
func NewTFJobWithEvaluatorAndNamespace(worker, ps, evaluator int, ns string) *tfv1beta1.TFJob {
