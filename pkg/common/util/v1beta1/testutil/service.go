...
func NewBaseService(name string, tfJob *tfv1beta1.TFJob, t *testing.T) *v1.Service {
	return &v1.Service{
...
func NewService(tfJob *tfv1beta1.TFJob, typ string, index int, t *testing.T) *v1.Service {
...
func NewServiceList(count int32, tfJob *tfv1beta1.TFJob, typ string, t *testing.T) []*v1.Service {
	services := []*v1.Service{}
...
func SetServices(serviceIndexer cache.Indexer, tfJob *tfv1beta1.TFJob, typ string, activeWorkerServices int32, t *testing.T) {
