	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrainerV2alpha1().TrainingRuntimes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrainerV2alpha1().TrainingRuntimes(namespace).Watch(context.TODO(), options)
			},
		},
		&trainerkubefloworgv2alpha1.TrainingRuntime{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trainingRuntimeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trainerkubefloworgv2alpha1.TrainingRuntime{}, f.defaultInformer)
}
