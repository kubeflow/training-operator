...
import (
	...
	trainerkubefloworgv2alpha1 "github.com/kubeflow/training-operator/pkg/apis/trainer.kubeflow.org/v2alpha1"
	...
	v2alpha1 "github.com/kubeflow/training-operator/pkg/client/listers/trainer.kubeflow.org/v2alpha1"
...
type ClusterTrainingRuntimeInformer interface {
	...
	Lister() v2alpha1.ClusterTrainingRuntimeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrainerV2alpha1().ClusterTrainingRuntimes().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrainerV2alpha1().ClusterTrainingRuntimes().Watch(context.TODO(), options)
			},
		},
		&trainerkubefloworgv2alpha1.ClusterTrainingRuntime{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterTrainingRuntimeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trainerkubefloworgv2alpha1.ClusterTrainingRuntime{}, f.defaultInformer)
}

func (f *clusterTrainingRuntimeInformer) Lister() v2alpha1.ClusterTrainingRuntimeLister {
	return v2alpha1.NewClusterTrainingRuntimeLister(f.Informer().GetIndexer())
}
