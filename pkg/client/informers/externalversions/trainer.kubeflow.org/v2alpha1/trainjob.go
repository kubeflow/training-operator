...
type TrainJobInformer interface {
	...
	Lister() v2alpha1.TrainJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrainerV2alpha1().TrainJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrainerV2alpha1().TrainJobs(namespace).Watch(context.TODO(), options)
			},
		},
		&trainerkubefloworgv2alpha1.TrainJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trainJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trainerkubefloworgv2alpha1.TrainJob{}, f.defaultInformer)
}

func (f *trainJobInformer) Lister() v2alpha1.TrainJobLister {
	return v2alpha1.NewTrainJobLister(f.Informer().GetIndexer())
}
