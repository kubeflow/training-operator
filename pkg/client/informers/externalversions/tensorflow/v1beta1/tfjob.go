...
import (
	...
	v1beta1 "github.com/kubeflow/tf-operator/pkg/client/listers/tensorflow/v1beta1"
...
func (f *tFJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tensorflowv1beta1.TFJob{}, f.defaultInformer)
}
