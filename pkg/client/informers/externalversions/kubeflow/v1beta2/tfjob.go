...
import (
	...
	v1beta2 "github.com/kubeflow/tf-operator/pkg/client/listers/kubeflow/v1beta2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.KubeflowV1beta2().TFJobs(namespace).List(options)
			},
...
func (f *tFJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tensorflow_v1beta2.TFJob{}, defaultTFJobInformer)
}

func (f *tFJobInformer) Lister() v1beta2.TFJobLister {
	return v1beta2.NewTFJobLister(f.Informer().GetIndexer())
}
