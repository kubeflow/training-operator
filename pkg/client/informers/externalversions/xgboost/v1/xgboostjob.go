...
import (
	...
	v1 "github.com/kubeflow/training-operator/pkg/client/listers/xgboost/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.XgboostV1().XGBoostJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.XgboostV1().XGBoostJobs(namespace).Watch(context.TODO(), options)
			},
		},
		&xgboostv1.XGBoostJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *xGBoostJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&xgboostv1.XGBoostJob{}, f.defaultInformer)
}
