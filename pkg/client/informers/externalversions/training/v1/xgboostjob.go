...
import (
	...
	v1 "github.com/kubeflow/training-operator/pkg/client/listers/training/v1"
...
func (f *xGBoostJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trainingv1.XGBoostJob{}, f.defaultInformer)
}
