	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeflowV2alpha1().TrainJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeflowV2alpha1().TrainJobs(namespace).Watch(context.TODO(), options)
			},
		},
		&kubefloworgv2alpha1.TrainJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trainJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubefloworgv2alpha1.TrainJob{}, f.defaultInformer)
}
