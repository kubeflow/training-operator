...
import (
	...
	v1 "github.com/kubeflow/training-operator/pkg/client/listers/pytorch/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PytorchV1().PyTorchJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PytorchV1().PyTorchJobs(namespace).Watch(context.TODO(), options)
			},
		},
