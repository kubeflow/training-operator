...
import (
	...
	v1 "github.com/kubeflow/training-operator/pkg/client/listers/mpi/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MpiV1().MPIJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MpiV1().MPIJobs(namespace).Watch(context.TODO(), options)
			},
		},
		&mpiv1.MPIJob{},
		resyncPeriod,
...
func (f *mPIJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mpiv1.MPIJob{}, f.defaultInformer)
}
