...
type trainingRuntimes struct {
	*gentype.ClientWithListAndApply[*v2alpha1.TrainingRuntime, *v2alpha1.TrainingRuntimeList, *kubefloworgv2alpha1.TrainingRuntimeApplyConfiguration]
}
...
func newTrainingRuntimes(c *KubeflowV2alpha1Client, namespace string) *trainingRuntimes {
	return &trainingRuntimes{
		gentype.NewClientWithListAndApply[*v2alpha1.TrainingRuntime, *v2alpha1.TrainingRuntimeList, *kubefloworgv2alpha1.TrainingRuntimeApplyConfiguration](
			"trainingruntimes",
			c.RESTClient(),
