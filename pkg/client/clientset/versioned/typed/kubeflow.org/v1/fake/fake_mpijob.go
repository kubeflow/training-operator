...
var mpijobsResource = v1.SchemeGroupVersion.WithResource("mpijobs")

var mpijobsKind = v1.SchemeGroupVersion.WithKind("MPIJob")
...
func (c *FakeMPIJobs) List(ctx context.Context, opts metav1.ListOptions) (result *v1.MPIJobList, err error) {
	...
	list := &v1.MPIJobList{ListMeta: obj.(*v1.MPIJobList).ListMeta}
	for _, item := range obj.(*v1.MPIJobList).Items {
...
func (c *FakeMPIJobs) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(mpijobsResource, c.ns, name, opts), &v1.MPIJob{})
...
func (c *FakeMPIJobs) Apply(ctx context.Context, mPIJob *kubefloworgv1.MPIJobApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MPIJob, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(mpijobsResource, c.ns, *name, types.ApplyPatchType, data), &v1.MPIJob{})
...
func (c *FakeMPIJobs) ApplyStatus(ctx context.Context, mPIJob *kubefloworgv1.MPIJobApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MPIJob, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(mpijobsResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1.MPIJob{})
