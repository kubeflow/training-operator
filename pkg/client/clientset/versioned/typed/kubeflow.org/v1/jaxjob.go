...
func (c *jAXJobs) Apply(ctx context.Context, jAXJob *kubefloworgv1.JAXJobApplyConfiguration, opts metav1.ApplyOptions) (result *v1.JAXJob, err error) {
	if jAXJob == nil {
...
func (c *jAXJobs) ApplyStatus(ctx context.Context, jAXJob *kubefloworgv1.JAXJobApplyConfiguration, opts metav1.ApplyOptions) (result *v1.JAXJob, err error) {
	if jAXJob == nil {
		return nil, fmt.Errorf("jAXJob provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
