...
type TrainingRuntimeInterface interface {
	...
	Apply(ctx context.Context, trainingRuntime *trainerkubefloworgv2alpha1.TrainingRuntimeApplyConfiguration, opts v1.ApplyOptions) (result *v2alpha1.TrainingRuntime, err error)
	TrainingRuntimeExpansion
}

// trainingRuntimes implements TrainingRuntimeInterface
type trainingRuntimes struct {
	*gentype.ClientWithListAndApply[*v2alpha1.TrainingRuntime, *v2alpha1.TrainingRuntimeList, *trainerkubefloworgv2alpha1.TrainingRuntimeApplyConfiguration]
}
...
func newTrainingRuntimes(c *TrainerV2alpha1Client, namespace string) *trainingRuntimes {
	return &trainingRuntimes{
		gentype.NewClientWithListAndApply[*v2alpha1.TrainingRuntime, *v2alpha1.TrainingRuntimeList, *trainerkubefloworgv2alpha1.TrainingRuntimeApplyConfiguration](
			"trainingruntimes",
			c.RESTClient(),
