...
func (c *FakeTrainJobs) Apply(ctx context.Context, trainJob *trainerkubefloworgv2alpha1.TrainJobApplyConfiguration, opts v1.ApplyOptions) (result *v2alpha1.TrainJob, err error) {
	if trainJob == nil {
...
func (c *FakeTrainJobs) ApplyStatus(ctx context.Context, trainJob *trainerkubefloworgv2alpha1.TrainJobApplyConfiguration, opts v1.ApplyOptions) (result *v2alpha1.TrainJob, err error) {
	if trainJob == nil {
		return nil, fmt.Errorf("trainJob provided to Apply must not be nil")
	}
	data, err := json.Marshal(trainJob)
