...
var tfjobsResource = schema.GroupVersionResource{Group: "kubeflow.org", Version: "v1beta1", Resource: "tfjobs"}

var tfjobsKind = schema.GroupVersionKind{Group: "kubeflow.org", Version: "v1beta1", Kind: "TFJob"}

// Get takes name of the tFJob, and returns the corresponding tFJob object, and an error if there is any.
func (c *FakeTFJobs) Get(name string, options v1.GetOptions) (result *v1beta1.TFJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tfjobsResource, c.ns, name), &v1beta1.TFJob{})
...
func (c *FakeTFJobs) List(opts v1.ListOptions) (result *v1beta1.TFJobList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tfjobsResource, tfjobsKind, c.ns, opts), &v1beta1.TFJobList{})
	...
	list := &v1beta1.TFJobList{ListMeta: obj.(*v1beta1.TFJobList).ListMeta}
	for _, item := range obj.(*v1beta1.TFJobList).Items {
...
func (c *FakeTFJobs) Create(tFJob *v1beta1.TFJob) (result *v1beta1.TFJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tfjobsResource, c.ns, tFJob), &v1beta1.TFJob{})
...
func (c *FakeTFJobs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tfjobsResource, c.ns, name), &v1beta1.TFJob{})
...
func (c *FakeTFJobs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.TFJobList{})
	return err
}

// Patch applies the patch and returns the patched tFJob.
func (c *FakeTFJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TFJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tfjobsResource, c.ns, name, pt, data, subresources...), &v1beta1.TFJob{})
