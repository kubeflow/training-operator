...
type TFJobInterface interface {
	...
	List(opts v1.ListOptions) (*v1beta1.TFJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TFJob, err error)
	TFJobExpansion
}
...
func newTFJobs(c *KubeflowV1beta1Client, namespace string) *tFJobs {
	return &tFJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tFJobs) Get(name string, options v1.GetOptions) (result *v1beta1.TFJob, err error) {
...
func (c *tFJobs) List(opts v1.ListOptions) (result *v1beta1.TFJobList, err error) {
	result = &v1beta1.TFJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tfjobs").
...
func (c *tFJobs) Create(tFJob *v1beta1.TFJob) (result *v1beta1.TFJob, err error) {
	result = &v1beta1.TFJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tfjobs").
...
func (c *tFJobs) Update(tFJob *v1beta1.TFJob) (result *v1beta1.TFJob, err error) {
	result = &v1beta1.TFJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tfjobs").
...
func (c *tFJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TFJob, err error) {
	result = &v1beta1.TFJob{}
