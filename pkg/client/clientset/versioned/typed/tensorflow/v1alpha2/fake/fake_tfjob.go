...
type FakeTFJobs struct {
	Fake *FakeTensorflowV1alpha2
	ns   string
}

var tfjobsResource = schema.GroupVersionResource{Group: "tensorflow", Version: "v1alpha2", Resource: "tfjobs"}

var tfjobsKind = schema.GroupVersionKind{Group: "tensorflow", Version: "v1alpha2", Kind: "TFJob"}
