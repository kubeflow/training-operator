...
type ClusterTrainingRuntimeInterface interface {
	...
	Apply(ctx context.Context, clusterTrainingRuntime *trainerv2alpha1.ClusterTrainingRuntimeApplyConfiguration, opts v1.ApplyOptions) (result *v2alpha1.ClusterTrainingRuntime, err error)
...
type clusterTrainingRuntimes struct {
	*gentype.ClientWithListAndApply[*v2alpha1.ClusterTrainingRuntime, *v2alpha1.ClusterTrainingRuntimeList, *trainerv2alpha1.ClusterTrainingRuntimeApplyConfiguration]
}
...
func newClusterTrainingRuntimes(c *TrainerV2alpha1Client) *clusterTrainingRuntimes {
	return &clusterTrainingRuntimes{
		gentype.NewClientWithListAndApply[*v2alpha1.ClusterTrainingRuntime, *v2alpha1.ClusterTrainingRuntimeList, *trainerv2alpha1.ClusterTrainingRuntimeApplyConfiguration](
