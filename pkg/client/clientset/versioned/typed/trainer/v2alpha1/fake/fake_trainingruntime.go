...
func (c *FakeTrainingRuntimes) Apply(ctx context.Context, trainingRuntime *trainerv2alpha1.TrainingRuntimeApplyConfiguration, opts v1.ApplyOptions) (result *v2alpha1.TrainingRuntime, err error) {
