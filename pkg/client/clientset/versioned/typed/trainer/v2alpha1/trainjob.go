...
type TrainJobInterface interface {
	...
	Apply(ctx context.Context, trainJob *trainerv2alpha1.TrainJobApplyConfiguration, opts v1.ApplyOptions) (result *v2alpha1.TrainJob, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, trainJob *trainerv2alpha1.TrainJobApplyConfiguration, opts v1.ApplyOptions) (result *v2alpha1.TrainJob, err error)
	TrainJobExpansion
}

// trainJobs implements TrainJobInterface
type trainJobs struct {
	*gentype.ClientWithListAndApply[*v2alpha1.TrainJob, *v2alpha1.TrainJobList, *trainerv2alpha1.TrainJobApplyConfiguration]
}

// newTrainJobs returns a TrainJobs
func newTrainJobs(c *TrainerV2alpha1Client, namespace string) *trainJobs {
	return &trainJobs{
		gentype.NewClientWithListAndApply[*v2alpha1.TrainJob, *v2alpha1.TrainJobList, *trainerv2alpha1.TrainJobApplyConfiguration](
			"trainjobs",
			c.RESTClient(),
