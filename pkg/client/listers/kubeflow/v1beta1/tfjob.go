...
type TFJobLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.TFJob, err error)
...
// List lists all TFJobs in the indexer.
func (s *tFJobLister) List(selector labels.Selector) (ret []*v1beta1.TFJob, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.TFJob))
	})
	return ret, err
}
...
type TFJobNamespaceLister interface {
	...
	Get(name string) (*v1beta1.TFJob, error)
...
// List lists all TFJobs in the indexer for a given namespace.
func (s tFJobNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.TFJob, err error) {
...
// Get retrieves the TFJob from the indexer for a given namespace and name.
func (s tFJobNamespaceLister) Get(name string) (*v1beta1.TFJob, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("tfjob"), name)
	}
	return obj.(*v1beta1.TFJob), nil
}
