...
import (
	...
	tfjobspec "github.com/kubeflow/tf-operator/pkg/apis/tensorflow/v1"
...
func main() {
	...
	oAPIDefs := tfjobspec.GetOpenAPIDefinitions(func(name string) spec.Ref {
