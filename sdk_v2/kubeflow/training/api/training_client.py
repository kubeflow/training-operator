...
class TrainingClient:
        ...
        try:
            ...
            for item in response["items"]:
                ...
                runtime = self.api_client.deserialize(
                    ...
                    models.TrainerV2alpha1ClusterTrainingRuntime,
                )
    ...
    def train(
        ...
        # Build the Trainer.
        trainer_crd = models.TrainerV2alpha1Trainer()
        ...
        train_job = models.TrainerV2alpha1TrainJob(
            api_version=constants.API_VERSION,
            kind=constants.TRAINJOB_KIND,
            metadata=client.V1ObjectMeta(name=train_job_name),
            spec=models.TrainerV2alpha1TrainJobSpec(
                runtime_ref=models.TrainerV2alpha1RuntimeRef(name=runtime_ref),
                trainer=(
                    trainer_crd
                    if trainer_crd != models.TrainerV2alpha1Trainer()
                    else None
                ),
    ...
    def list_jobs(self, runtime_ref: Optional[str] = None) -> List[types.TrainJob]:
        ...
        Returns:
            List[TrainerV2alpha1TrainJob]: List of created TrainJobs.
    ...
    def __get_trainjob_from_crd(
        self,
        trainjob_crd: models.TrainerV2alpha1TrainJob,
    ) -> types.TrainJob:
