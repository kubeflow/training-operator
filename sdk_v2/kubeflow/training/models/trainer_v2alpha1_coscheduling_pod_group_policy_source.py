...
class TrainerV2alpha1CoschedulingPodGroupPolicySource(object):
    ...
    def __init__(self, schedule_timeout_seconds=None, local_vars_configuration=None):  # noqa: E501
        """TrainerV2alpha1CoschedulingPodGroupPolicySource - a model defined in OpenAPI"""  # noqa: E501
    ...
    def schedule_timeout_seconds(self):
        """Gets the schedule_timeout_seconds of this TrainerV2alpha1CoschedulingPodGroupPolicySource.  # noqa: E501
        ...
        :return: The schedule_timeout_seconds of this TrainerV2alpha1CoschedulingPodGroupPolicySource.  # noqa: E501
        :rtype: int
        """
    ...
    def schedule_timeout_seconds(self, schedule_timeout_seconds):
        """Sets the schedule_timeout_seconds of this TrainerV2alpha1CoschedulingPodGroupPolicySource.

        Time threshold to schedule PodGroup for gang-scheduling. If the scheduling timeout is equal to 0, the default value is used. Defaults to 60 seconds.  # noqa: E501

        :param schedule_timeout_seconds: The schedule_timeout_seconds of this TrainerV2alpha1CoschedulingPodGroupPolicySource.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrainerV2alpha1CoschedulingPodGroupPolicySource):
            return False
