...
class TrainerKubeflowOrgV2alpha1MPIMLPolicySource(object):
    ...
    def __init__(self, mpi_implementation=None, num_proc_per_node=None, run_launcher_as_node=None, ssh_auth_mount_path=None, local_vars_configuration=None):  # noqa: E501
        """TrainerKubeflowOrgV2alpha1MPIMLPolicySource - a model defined in OpenAPI"""  # noqa: E501
    ...
    def mpi_implementation(self):
        """Gets the mpi_implementation of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501

        Implementation name for the MPI to create the appropriate hostfile. Defaults to OpenMPI.  # noqa: E501

        :return: The mpi_implementation of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :rtype: str
        """
    ...
    def mpi_implementation(self, mpi_implementation):
        """Sets the mpi_implementation of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.

        Implementation name for the MPI to create the appropriate hostfile. Defaults to OpenMPI.  # noqa: E501

        :param mpi_implementation: The mpi_implementation of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :type: str
        """
    ...
    def num_proc_per_node(self):
        """Gets the num_proc_per_node of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501

        Number of processes per node. This value is equal to the number of slots for each node in the hostfile.  # noqa: E501

        :return: The num_proc_per_node of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :rtype: int
        """
    ...
    def num_proc_per_node(self, num_proc_per_node):
        """Sets the num_proc_per_node of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.

        Number of processes per node. This value is equal to the number of slots for each node in the hostfile.  # noqa: E501

        :param num_proc_per_node: The num_proc_per_node of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :type: int
        """
    ...
    def run_launcher_as_node(self):
        """Gets the run_launcher_as_node of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501

        Whether to run training process on the launcher Job. Defaults to false.  # noqa: E501

        :return: The run_launcher_as_node of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :rtype: bool
        """
    ...
    def run_launcher_as_node(self, run_launcher_as_node):
        """Sets the run_launcher_as_node of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.

        Whether to run training process on the launcher Job. Defaults to false.  # noqa: E501

        :param run_launcher_as_node: The run_launcher_as_node of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :type: bool
        """
    ...
    def ssh_auth_mount_path(self):
        """Gets the ssh_auth_mount_path of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501

        Directory where SSH keys are mounted.  # noqa: E501

        :return: The ssh_auth_mount_path of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :rtype: str
        """
    ...
    def ssh_auth_mount_path(self, ssh_auth_mount_path):
        """Sets the ssh_auth_mount_path of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.

        Directory where SSH keys are mounted.  # noqa: E501

        :param ssh_auth_mount_path: The ssh_auth_mount_path of this TrainerKubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrainerKubeflowOrgV2alpha1MPIMLPolicySource):
            return False
