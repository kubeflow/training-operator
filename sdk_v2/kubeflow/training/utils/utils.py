...
def get_dataset_config(
...
) -> Optional[models.TrainerV2alpha1DatasetConfig]:
    """
    ...
    ds_config = models.TrainerV2alpha1DatasetConfig(
        storage_uri=(
...
def get_model_config(
...
) -> Optional[models.TrainerV2alpha1ModelConfig]:
    """
    ...
    # TODO (andreyvelich): Support more parameters.
    m_config = models.TrainerV2alpha1ModelConfig(
        input=models.TrainergV2alpha1InputModel(storage_uri=model_config.storage_uri)
    )
