...
class KubeflowOrgV2alpha1MPIMLPolicySource(object):
    ...
    def mpi_implementation(self):
        """Gets the mpi_implementation of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501

        Implementation name for the MPI to create the appropriate hostfile. Defaults to OpenMPI.  # noqa: E501

        :return: The mpi_implementation of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :rtype: str
        """
    ...
    def mpi_implementation(self, mpi_implementation):
        """Sets the mpi_implementation of this KubeflowOrgV2alpha1MPIMLPolicySource.

        Implementation name for the MPI to create the appropriate hostfile. Defaults to OpenMPI.  # noqa: E501

        :param mpi_implementation: The mpi_implementation of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :type: str
        """
    ...
    def num_proc_per_node(self):
        """Gets the num_proc_per_node of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501

        Number of processes per node. This value is equal to the number of slots for each node in the hostfile.  # noqa: E501

        :return: The num_proc_per_node of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :rtype: int
        """
    ...
    def num_proc_per_node(self, num_proc_per_node):
        """Sets the num_proc_per_node of this KubeflowOrgV2alpha1MPIMLPolicySource.

        Number of processes per node. This value is equal to the number of slots for each node in the hostfile.  # noqa: E501

        :param num_proc_per_node: The num_proc_per_node of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :type: int
        """
    ...
    def run_launcher_as_node(self):
        """Gets the run_launcher_as_node of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501

        Whether to run training process on the launcher Job. Defaults to false.  # noqa: E501

        :return: The run_launcher_as_node of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :rtype: bool
        """
    ...
    def run_launcher_as_node(self, run_launcher_as_node):
        """Sets the run_launcher_as_node of this KubeflowOrgV2alpha1MPIMLPolicySource.

        Whether to run training process on the launcher Job. Defaults to false.  # noqa: E501

        :param run_launcher_as_node: The run_launcher_as_node of this KubeflowOrgV2alpha1MPIMLPolicySource.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KubeflowOrgV2alpha1MPIMLPolicySource):
            return False
